            ...
            <div className="max-w-10/12 mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center">
                    {pricingPlans.map((plan, index) => (
                        <div
                            key={index}
                            className={`relative p-10 rounded-[2.5rem] border transition-all duration-500 ${plan.isPro
                        ...
                        >
                            ...
                            {/* Action Button */}
                            <button className={`w-full py-4.5 rounded-2xl font-bold text-sm transition-all active:scale-95 ${plan.isPro
